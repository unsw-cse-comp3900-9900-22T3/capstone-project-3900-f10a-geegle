...
eventRouter.get('/:eventID/reviews', verifyToken, getEventReviewsController); //get all reviews for an event
...
eventRouter.post('/:eventID/reviews/:reviewID/like', (req, res) => {}); // add like to a review parent
eventRouter.delete('/:eventID/reviews/:reviewID/unlike', (req, res) => {}); // remove like to parent review
...
eventRouter.get('/:eventID/reviews/:reviewID/reply/:replyID', (req, res) => {}); // edit a reply for an event if its yours
eventRouter.post('/:eventID/reviews/:reviewID/reply/:replyID', (req, res) => {}); // delete a review for an event if its yours
